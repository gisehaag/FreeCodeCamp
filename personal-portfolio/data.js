const projects = {
	'free-code-camp': {
		...
		'inspirationURL': 'http://freecodecamp.org/learn/',
	...
	'tictactoe': {
		...
		'inspirationTitle': '',
		'inspirationURL': '',
		'description': 'JavaScript its, up to now, my favorite coding language, and I looking for projects to practice it, I saw a Tic Tac Toe game, but can´t remember where was. I worked with OOP creating my object the game. The constructor has few elements and the basic methods for cell defination, reset scores, assing elements and add event listeners. The logic of the game was very fan to develop, and I had to play a lot! I think that was this projects, in which I finished my understanding of this and specially the bind method.',
	...
	'mediaplayer': {
		...
		'date': 'ene-21',
		'technology': ['html5', 'css3', 'javascript', 'github'],
		'inspirationTitle': 'Platzi | Curso de Profesional de JavaScript',
		'inspirationURL': 'https://platzi.com/clases/javascript-profesional/',
		'description': '',
	...
	'catalogo': {
		...
		'inspirationTitle': 'Catalogo de ventas Vivanco-Haag',
		'inspirationURL': 'https://catalogo.ilanvivanco.com/',
		'description': '',
	...
	'play2fund': {
		...
		'date': 'oct-20',
		'technology': ['php', 'wordpress'],
		'inspirationTitle': 'Play2fund',
		'inspirationURL': 'https://play2fund.com/',
	...
	'checkboxes': {
		...
		'inspirationTitle': 'Wes Bos | #Javascript30',
		'inspirationURL': 'https://javascript30.com/',
		'description': '',
	...
	'to-do-list': {
		...
		'inspirationTitle': '100+ JavaScript Projects for Beginners!',
		'inspirationURL': 'https://jsbeginners.com/todo-list-javascript-project-v1/',
	...
	'budget-app': {
		...
		'technology': ['html5', 'css3', 'javascript'],
		'inspirationTitle': '100+ JavaScript Projects for Beginners!',
		'inspirationURL': 'https://jsbeginners.com/javascript-budget-app/',
		'description': '',
	...
	'tip-calculator': {
		...
		'technology': ['html5', 'css3', 'javascript'],
		'inspirationTitle': '100+ JavaScript Projects for Beginners!',
		'inspirationURL': 'https://jsbeginners.com/tip-form-javascript-project/',
	...
	'cart-project': {
		...
		'technology': ['html5', 'css3', 'javascript'],
		'inspirationTitle': '100+ JavaScript Projects for Beginners!',
		'inspirationURL': 'https://jsbeginners.com/grocery-cart-javascript-project/',
		'description': '',
	...
	'clone-site': {
		...
		'inspirationTitle': '',
		'inspirationURL': 'https://colorlib.com/preview/#original',
	...
	'atm': {
		...
		'date': 'abr-20',
		'technology': ['html5', 'css3', 'javascript'],
		'inspirationTitle': 'Platzi | Curso de Programación Básica',
		'inspirationURL': 'https://platzi.com/clases/programacion-basica/',
		'description': 'Uno de los primeros proyectos que hice en el curso de programación básica de Platzi. Incorporé los billetes argentinos de la colección de animales que me gusta mucho.',
